...
namespace SaintAlberts
{
    public partial class MainForm : Form
    {
        ...
        {
            if (frmWardDelete == null)
            {
                frmWardDelete = new WardDeleteForm(DC, this);
            }
            frmWardDelete.ShowDialog();
        }

        private void btnAddMedication_Click(object sender, EventArgs e)
        {
            if (frmMedicationAdd == null)
            {
                frmMedicationAdd = new MedicationAddForm(DC, this);
            }
            frmMedicationAdd.ShowDialog();
        }
        ...
        private void btnAddWard_Click(object sender, EventArgs e)
        {
            if (frmWardAdd == null)
            {
                frmWardAdd = new WardAddForm(DC, this);
            }
            frmWardAdd.ShowDialog();
        }
    }
}
